...
exports.AccountManager = class AccountManager {
  ...
  attachPolicies (iamUser, accessPolicies) {
    return this._attachUserPolicies(iamUser, accessPolicies.userPolicyArns || [])
  };

  detachPolicies (iamUser, accessPolicies) {
    return this._detachUserPolicies(iamUser, accessPolicies.userPolicyArns || [])
  };

  addToGroups (iamUser, accessPolicies) {
    return this._addToGroups(iamUser, accessPolicies.groups || [])
  };

  removeFromGroups (iamUser, accessPolicies) {
    return this._removeFromGroups(iamUser, accessPolicies.groups || [])
  };
